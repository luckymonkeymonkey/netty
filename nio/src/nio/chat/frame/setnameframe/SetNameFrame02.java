package nio.chat.frame.setnameframe;
...
import nio.chat.client.ChatClient;
import nio.chat.frame.chatframe.ChatFrame;

public class SetNameFrame02 extends JFrame {
    private static final long serialVersionUID = 1L;
    private static JTextField txtName;
    private static JButton btnOK;
    private static JLabel label;

    public SetNameFrame02() {
        this.setLayout(null);
    ...
    public static void main(String[] args) {
        SetNameFrame02 setNameFrame = new SetNameFrame02();
